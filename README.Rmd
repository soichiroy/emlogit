...
Applications to the multinomial outcome in the context of deriving the EM algorithm based on Polya-Gamma representation can be found in Russo et al. (2018) and Goplerud (2019), among others.
...
+ Russo, M., Durante, D., & Scarpa, B. (2018). [Bayesian inference on group differences in multivariate categorical data.](https://doi.org/10.1016/j.csda.2018.04.010) _Computational Statistics & Data Analysis,_ 126, 136-149.
